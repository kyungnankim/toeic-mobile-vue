...
async function enhanceHomeResponse(request) {
  ...
  if (!text.includes('/home-sentences-link.js')) {
    text = text.replace('</body>', '  <script src="/home-sentences-link.js"></script>\n</body>')
  }
  if (!text.includes('/home-ebook-link.js')) {
    text = text.replace('</body>', '  <script src="/home-ebook-link.js"></script>\n</body>')
  }
